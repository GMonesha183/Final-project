...
def load_gesture_model():
    ...
    model_paths = [
        os.path.join('saradhe', 'hand_gesture_resnet50v2_model.h5'),  # Original path
        'hand_gesture_best_model.h5',                           # Same directory
        os.path.join('models', 'hand_gesture_resnet50v2_model.h5'),   # Models directory
    ]
